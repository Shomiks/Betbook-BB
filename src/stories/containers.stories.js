...
const someContent = <div>The standard Lorem Ipsum passage, used since the 1500s
...
stories
    .add('Bottom Container', () => <BottomContainer></BottomContainer>);

stories
    .add('Footer Container', () => <FooterContainer>{someContent}</FooterContainer>);
