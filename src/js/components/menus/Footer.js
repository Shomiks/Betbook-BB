...
class Footer extends React.Component {
    constructor(props) {
        ...
        this.state = {
            currentState: false,
            currentActive: props.activeItem ? props.activeItem : null
        };
    ...
    render() {
        ...
        return (
            <div className='rectangle_footer'>
                <div
                    ...
                    <Link to={`/home`}>
                        <div className='timeline'>
                            <span>{this.state.currentActive == 'timeline' ?
                                <div className='center-text'><span className='text10-white'>Home</span>
                                </div> : ''}</span></div>
                    </Link>
                </div>
                <div
                    className={this.state.currentActive == 'ball' ? 'ft_countries-field active' : 'ft_countries-field'}>
                    <Link to={`/countries`}>
                        <div className='ball'>
                            <span>{this.state.currentActive == 'ball' ?
                ...
                <div
                    className={this.state.currentActive == 'profile' ? 'ft_profile-field active-profile' : 'ft_profile-field'}>
                    <Link to={`/profile`}>
                        <div className='profile'>
                            <span>{this.state.currentActive == 'profile' ?
