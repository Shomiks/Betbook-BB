        ...
        return <div className={props ? 'ms-central-field' : 'ms-central-field yellow'}>
            <DateResultFixtureShort {...props} renderDate={() => this.renderDate}/>
                <div className='ms-under-teams-field'>
                    {!props ? (!props.fixture.result ? <div className='ms_not-bided-yellow'><span className='text11-white'>Make a bid</span></div> : <div/>)
                        : (
                        <div className='ms_bid-field'>
                        <div className={'ms_bid-box' + handleStateField(1)}>
                        <div className='ms_game-field'><span className='text11-grey'>{props.game1_tip ? props.game1_tip.toUpperCase() : ''}</span></div>
                        <div className='ms_odd-field'><span className='text11-white'>{props.game1_odd}</span></div>
                        </div>
                        <div className={'ms_bid-box' + handleStateField(2)}>
                        <div className='ms_game-field'><span className='text11-grey'>{parseTipGame2Row1() == '0-' ? (parseTipGame2Row1() + props.game2_tip) : parseTipGame2Row2()}</span></div>
                        <div className='ms_odd-field'><span className='text11-white'>{props.game2_odd}</span></div>
                        </div>
                        <div className={'ms_bid-box' + handleStateField(3)}>
                        <div className='ms_game-field'><span className='text11-grey'>{props.game3_tip == 'gg' ? 'GG' : 'GG3+'}</span></div>
                        <div className='ms_odd-field'><span className='text11-white'>{props.game3_odd}</span></div>
                        </div>
                        <div className={'ms_bid-box' + handleStateField(4)}>
                        <div className='ms_game-field'><span className='text11-grey'>{props.game4_tip ? parseTipGame4() : ''}</span></div>
                        <div className='ms_odd-field'><span className='text11-white'>{props.game4_odd}</span></div>
                        </div>
                        </div>)}
                </div>
            </div>
