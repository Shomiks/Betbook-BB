    ...
    calculateStatistics = (res) => {
        ...
        if(!res){
           ...
           game3_total : 0,
            ...
            statisticsCalculated.game1_success = ((res.game1_total_win / res.game1_total) * 100).toFixed(2) + '%';
            statisticsCalculated.game2_avg = (res.game2_sum / res.game2_total_win).toFixed(2);
            statisticsCalculated.game2_success = ((res.game2_total_win / res.game2_total) * 100 ).toFixed(2)+ '%';
            statisticsCalculated.game3_avg = (res.game3_sum / res.game3_total_win).toFixed(2);
            statisticsCalculated.game3_success = ((res.game3_total_win / res.game3_total) * 100).toFixed(2) + '%';
            statisticsCalculated.game4_avg = (res.game4_sum / res.game4_total_win).toFixed(2);
            statisticsCalculated.game4_success = ((res.game4_total_win / res.game4_total) * 100).toFixed(2) + '%';
        }
