            ...
            if(this.state.authenticated) {
                return (<div className='App'>
                    <HashRouter>
                        ...
                        <Route path="/forgot-password" render={(props) => (<Forgot_Password sharedObj={this.sharedObject} {...props}/>)}/>
                        ...
                        <Route path="/finished/league/:leagueid" render={(props) => (<League_Fixtures sharedObj={this.sharedObject} {...props}/>)}/>
