...
import OfferBetSlip from './modules/offerBetSlip/offerBetSlip.component';
...
class App extends React.Component {
    render() {
        return (
            <Router>
                <div>
                    <Route path="/" exact strict component={SocialTimeline}/>
                    <Route path="/sport" exact component={OfferSport} />
                    <Route path="/country/:sportId" exact component={OfferSport} />
                    <Route path="/league/:sportId/:countryId" exact component={OfferSport} />
                    <Route path="/offerleague" exact component={OfferLeague} />
                </div>
            </Router>
        )
    }
...
//                         </li>
//                         <li>
//                             <a href='#offerbetslip'>OfferBetSlip</a>
//                         </li>
//                         <li>
